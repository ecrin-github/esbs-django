...
class DataTransferAccesses(models.Model):
    ...
    repo_signature1 = models.ForeignKey(Users, on_delete=models.CASCADE, db_column='repo_signature_1', null=True,
                                        related_name='dta_repo_signature_1', default=None,
                                        db_constraint=IS_USERS_DB_CONSTRAINT)
    repo_signature2 = models.ForeignKey(Users, on_delete=models.CASCADE, db_column='repo_signature_2', null=True,
                                        related_name='dta_repo_signature_2', default=None,
                                        db_constraint=IS_USERS_DB_CONSTRAINT)
    provider_signature1 = models.ForeignKey(Users, on_delete=models.CASCADE, db_column='provider_signature_1', null=True,
                                            related_name='dta_provider_signature_1', default=None,
                                            db_constraint=IS_USERS_DB_CONSTRAINT)
    provider_signature2 = models.ForeignKey(Users, on_delete=models.CASCADE, db_column='provider_signature_2', null=True,
